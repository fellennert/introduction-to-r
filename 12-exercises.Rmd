...
Firstly, download and extract [the zip file](https://www.dropbox.com/s/ptnot75sed1lupx/training-files.zip?dl=0). Then…
...
7. Extend the Roulette function (colors!). You will need a lot of if...else. Try to split it up into functions (e.g., `determine_color`). Make it "bullet-proof" -- how should you go across cases where people bet on a number and a color? 
