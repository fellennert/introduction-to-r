# Factors with `forcats` {#workwithfactors}
...
* You can also consult the `introverse` package if you need help with the packages covered here -- `introverse::show_topics("forcats")` will give you an overview of the `forcats` package's functions, and `get_help("name of function")` will help you with the respective function.